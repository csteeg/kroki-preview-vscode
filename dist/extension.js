 ...
 *--------------------------------------------------------------------------------------------*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ToggleLockCommand = exports.ShowSourceCommand = exports.ShowPreviewToSideCommand = exports.ShowPreviewCommand = exports.ShowLockedPreviewToSideCommand = exports.RefreshPreviewCommand = exports.OpenDocumentLinkCommand = exports.MoveCursorToPositionCommand = void 0;
var moveCursorToPosition_1 = __webpack_require__(/*! ./moveCursorToPosition */ "./src/commands/moveCursorToPosition.ts");
...
var openDocumentLink_1 = __webpack_require__(/*! ./openDocumentLink */ "./src/commands/openDocumentLink.ts");
...
var refreshPreview_1 = __webpack_require__(/*! ./refreshPreview */ "./src/commands/refreshPreview.ts");
...
var showPreview_1 = __webpack_require__(/*! ./showPreview */ "./src/commands/showPreview.ts");
...
var showSource_1 = __webpack_require__(/*! ./showSource */ "./src/commands/showSource.ts");
Object.defineProperty(exports, "ShowSourceCommand", ({ enumerable: true, get: function () { return showSource_1.ShowSourceCommand; } }));
var toggleLock_1 = __webpack_require__(/*! ./toggleLock */ "./src/commands/toggleLock.ts");
...
class MoveCursorToPositionCommand {
    id = "_kroki.moveCursorToPosition";
...
const vscode = __importStar(__webpack_require__(/*! vscode */ "vscode"));
const file_1 = __webpack_require__(/*! ../util/file */ "./src/util/file.ts");
class OpenDocumentLinkCommand {
    static id = "_kroki.openDocumentLink";
    id = OpenDocumentLinkCommand.id;
    ...
    async tryOpen(path, args) {
        ...
        if (vscode.window.activeTextEditor &&
            (0, file_1.isPreviewableFile)(vscode.window.activeTextEditor.document) &&
...
async function showPreview(webviewManager, uri, previewSettings) {
    ...
    if (!(resource instanceof vscode.Uri)) {
        if (!vscode.window.activeTextEditor) {
            ...
            return vscode.commands.executeCommand("kroki.showSource");
        }
...
class ShowLockedPreviewToSideCommand {
    webviewManager;
    id = "kroki.showLockedPreviewToSide";
    constructor(webviewManager) {
        this.webviewManager = webviewManager;
    }
    execute(uri) {
...
const commands = __importStar(__webpack_require__(/*! ./commands/index */ "./src/commands/index.ts"));
const previewContentProvider_1 = __webpack_require__(/*! ./features/previewContentProvider */ "./src/features/previewContentProvider.ts");
const previewManager_1 = __webpack_require__(/*! ./features/previewManager */ "./src/features/previewManager.ts");
...
function activate(context) {
    ...
    const contentProvider = new previewContentProvider_1.HTMLContentProvider(context, logger);
    ...
    vscode.workspace.onDidOpenTextDocument((document) => {
        if ((0, file_1.isPreviewableFile)(document)) {
...
const nls = __importStar(__webpack_require__(/*! vscode-nls */ "./node_modules/vscode-nls/lib/node/main.js"));
...
class HTMLPreview {
    ...
    forceUpdate = false;
    _disposed = false;
    static async revive(webview, state, contentProvider, logger) {
        const resource = vscode.Uri.parse(state.resource);
        const locked = state.locked;
        const preview = new HTMLPreview(webview, resource, locked, contentProvider, logger);
        preview.editor.webview.options = HTMLPreview.getWebviewOptions(resource);
        await preview.doUpdate();
        return preview;
    }
    static create(resource, previewColumn, locked, contentProvider, logger) {
        const webview = vscode.window.createWebviewPanel(HTMLPreview.viewType, HTMLPreview.getPreviewTitle(resource, locked), previewColumn, {
            enableFindWidget: true,
            ...HTMLPreview.getWebviewOptions(resource),
        });
        return new HTMLPreview(webview, resource, locked, contentProvider, logger);
    }
    constructor(webview, resource, locked, _contentProvider, _logger) {
        ...
        vscode.window.onDidChangeActiveTextEditor((editor) => {
            if (editor && (0, file_1.isPreviewableFile)(editor.document) && !this._locked) {
    ...
    async doUpdate() {
        ...
        const content = await this._contentProvider.provideTextDocumentContent(document);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HTMLContentProvider = void 0;
...
class HTMLContentProvider {
    ...
    async getImages(document) {
        const supportedFiles = vscode.workspace
            ...
            .get("supportedFiles", []);
        const diagram_type = supportedFiles.find((file) => file.extension === `.${document.uri.fsPath.split(".").pop()}`)?.type;
    ...
    async getImageHtml(text, diagram_type) {
        try {
            const response = await axios_1.default.post(`https://kroki.io`, {
                diagram_source: text,
    ...
    async getImagesForStructurizr(document) {
        ...
        try {
            ...
            const sendPumlToKroki = async (pumlFileName) => {
            ...
            const errorDetail = ("stderr" in error ? error.stderr.toString() : error instanceof Error ? error.message : JSON.stringify(error)).replace(cachedPostFix, "");
            return {
                imgHtml: "",
...
<body>
    ...
    errorDocumentContent(errorHtml) {
        return `
<html>
<head>
    <meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src vscode-resource: https: data:; media-src vscode-resource: https: data:; script-src https: vscode-resource:; style-src vscode-resource: 'unsafe-inline' https: data:; font-src vscode-resource: https: data:;">
...
<body>
    ...
    async provideTextDocumentContent(document, initialLine = undefined) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HTMLPreviewManager = void 0;
const vscode = __importStar(__webpack_require__(/*! vscode */ "vscode"));
const dispose_1 = __webpack_require__(/*! ../util/dispose */ "./src/util/dispose.ts");
const preview_1 = __webpack_require__(/*! ./preview */ "./src/features/preview.ts");
class HTMLPreviewManager {
    _contentProvider;
    _logger;
    static htmlPreviewActiveContextKey = "kroki.PreviewFocus";
    _previews = [];
    ...
    createNewPreview(resource, previewSettings) {
        const preview = preview_1.HTMLPreview.create(resource, previewSettings.previewColumn, previewSettings.locked, this._contentProvider, this._logger);
...
class Logger {
    trace;
    outputChannel = (0, lazy_1.lazy)(() => vscode.window.createOutputChannel("HTML"));
    constructor() {
    ...
    readTrace() {
        return Trace.fromString(vscode.workspace.getConfiguration().get("kroki.trace", "off"));
    }
...
const vscode = __importStar(__webpack_require__(/*! vscode */ "vscode"));
function isPreviewableFile(document) {
    const supportedFiles = vscode.workspace
        .getConfiguration()
...
var ral_1 = __webpack_require__(/*! ./ral */ "./node_modules/vscode-nls/lib/common/ral.js");
var MessageFormat;
...
var path = __webpack_require__(/*! path */ "path");
var fs = __webpack_require__(/*! fs */ "fs");
var ral_1 = __webpack_require__(/*! ../common/ral */ "./node_modules/vscode-nls/lib/common/ral.js");
var common_1 = __webpack_require__(/*! ../common/common */ "./node_modules/vscode-nls/lib/common/common.js");
var common_2 = __webpack_require__(/*! ../common/common */ "./node_modules/vscode-nls/lib/common/common.js");
