...
export class ShowPreviewCommand implements Command {
  public readonly id = "kroki.showPreview";

  public constructor(private readonly webviewManager: HTMLPreviewManager) {}
...
export class ShowPreviewToSideCommand implements Command {
  public readonly id = "kroki.showPreviewToSide";
...
export class ShowLockedPreviewToSideCommand implements Command {
  public readonly id = "kroki.showLockedPreviewToSide";
