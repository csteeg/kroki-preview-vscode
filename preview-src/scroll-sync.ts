  ...
  return () => {
    if (!elements) {
      elements = Array.prototype.map
        .call(document.getElementsByClassName("code-line"), (element: HTMLElement) => {
          const line = parseInt(element?.getAttribute("data-line") || "0");
          return { element, line } as CodeLineElement;
        })
